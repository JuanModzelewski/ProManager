    ...
    **Context:**
    ...
    def get_queryset(self):
        ...
        return Project.objects.filter(Q(
            author=self.request.user) | Q(
                projectteam__members=self.request.user)).distinct()
    ...
    if request.method == "POST":
        ...
        if project_form.is_valid() and request.user.is_authenticated:
            ...
            messages.success(request,
                             f"The project <strong> {new_project.title} \
...
def delete_project(request, project_id):
    ...
    **Context:**
    ...
    if project.author == request.user:
        project.delete()
        messages.success(request,
                         f"The project <strong> {project.title} \
                            </strong> has been deleted."
                         )
        return HttpResponseRedirect(reverse('projects'))
    else:
        messages.error(request,
                       f"You are not authorized to delete this project."
                       )
        return HttpResponseRedirect(reverse('projects'))
...
def edit_project(request, project_id):
    ...
    **Context:**
    ...
    if project.author == request.user:
        ...
        messages.error(request,
                       f"You are not authorized to edit this project."
                       )
        return HttpResponseRedirect(reverse('projects'))
